module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    paths: {
      ...
      dust: '<%=paths.project%>/node_modules/dustjs-linkedin-fixed-with-source/dist/dust-full.js',
      dustMin: '<%=paths.project%>/node_modules/dustjs-linkedin-fixed-with-source/dist/dust-full.min.js',
