    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          ...
          source:
            '<div>{@math key="13" method="add" operand="12"}{@gt value=123}13 + 12 > 123{:else}Math is fun{/gt}{/math}</div>',
          context: {},
        ...
        },
        {
          ...
          source:
            '<div>{@math key="13" method="add" operand="12"}{@gt value=123}13 + 12 > 123{/gt}{@none}Math is fun{/none}{/math}</div>',
          context: {},
          expected: '<div>Math is fun</div>',
        ...
        },
        {
          ...
          source:
            '<div>{@math key="1" method="add" operand="1"}math with body is truthy{:else}else is meaningless{/math}</div>',
          context: {},
        ...
        },
        {
          ...
          source:
            '<div>{@math key="1" method="subtract" operand="1"}math with body is truthy even if mathout is falsy{:else}else is meaningless{/math}</div>',
          context: {},
        ...
        },
        {
          ...
          source:
            '{@math key=1 method="subtract" operand=2}{@any}Positive!{/any}{@none}Negative!{/none}{@gte value=0/}{/math}',
          context: {},
          expected: 'Negative!',
      ...
      tests: [
        {
          ...
          source:
            '{@gt key="22" value="3" type="string"}22 greater than 3 with type string {:else}22 not greater than 3 with type string{/gt}',
          context: {},
    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          ...
          source: ['{@select key="foo"}', '{@eq value="foo"}foo{/eq}', '{/select}'].join('\n'),
          context: {},
          expected: 'foo',
        ...
        },
        {
          ...
          source: ['{@select key=foo}', '{@eq value=10}foobar{/eq}', '{/select}'].join('\n'),
          context: { foo: 10 },
          expected: 'foobar',
        ...
        },
        {
          ...
          source: ['{@select key=foo}', '{@lt value=20}foobar{/lt}', '{/select}'].join('\n'),
          context: { foo: 10 },
          expected: 'foobar',
        ...
        },
        {
          ...
          source: ['{@select key=foo}', '{@lte value=10}foobar{/lte}', '{/select}'].join('\n'),
          context: { foo: 10 },
          expected: 'foobar',
        ...
        },
        {
          ...
          source: ['{@select key=foo}', '{@lte value=11}foobar{/lte}', '{/select}'].join('\n'),
          context: { foo: 10 },
          expected: 'foobar',
        ...
        },
        {
          ...
          source: ['{@select key=foo}', '{@gt value=5}foobar{/gt}', '{/select}'].join('\n'),
          context: { foo: 10 },
          expected: 'foobar',
        ...
        },
        {
          ...
          source: ['{@select key=foo}', '{@gte value=10}foobar{/gte}', '{/select}'].join('\n'),
          context: { foo: 10 },
          expected: 'foobar',
        ...
        {
          name: 'select helper with variable and one condition gte',
          source: ['{@select key=foo}', '{@gte value=5}foobar{/gte}', '{/select}'].join('\n'),
          context: { foo: 10 },
          expected: 'foobar',
          message: 'should test select helper with variable and one condition gte',
        },
        {
          ...
          source: ['{@select key=foo}', '{@gte value=0}foobar{/gte}', '{/select}'].join('\n'),
          context: { foo: 0 },
          expected: 'foobar',
          message: 'should test select helper with variable and one condition gte',
        },
        {
          ...
          source: ['{@select key="{foo}"}', '{@eq value="bar"}foobar{/eq}', '{/select}'].join('\n'),
          context: { foo: 'bar' },
          expected: 'foobar',
        ...
        },
        {
          ...
          context: {
            data: {
              messages: [{ message: 'done' }, { message: 'default' }],
            },
          },
    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          ...
          source:
            '{@select key=foo}{@any}Hello{/any}{@eq value="bar"}{@select key=moo}{@eq value="cow"/}{@any} Cow{/any}{/select}{/eq}{@any} World{/any}{/select}',
        ...
        },
        {
          ...
          source:
            '{@select key=foo}{@eq value="bar"/}{@any}Hello{@select key=moo}{@eq value="cow"/}{@any} World{/any}{/select}{/any}{/select}',
          context: { foo: 'bar', moo: 'cow' },
          expected: 'Hello World',
        ...
        },
        {
          ...
          source:
            '{@select key=foo}{@eq value="foo"/}{@any}{@eq key=a value="a"}A!{/eq} {@eq key=b value="b"}B!{/eq} {@eq key=c value="d"}ERROR!{/eq}{/any}{/select}',
    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          ...
          source:
            '{@select key=foo}{@eq value="bar"/}{@none}Hello{@select key=moo}{@eq value="cow"/}{@none} World{/none}{/select}{/none}{/select}',
        ...
        },
        {
          ...
          source:
            '{@select key=foo}{@none}{@eq key=a value="a"}A!{/eq} {@eq key=b value="b"}B!{/eq} {@eq key=c value="d"}ERROR!{/eq}{/none}{/select}',
          context: { a: 'a', b: 'b', c: 'c' },
          expected: 'A! B! ',
    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          ...
          message:
            'should test if tap helper is working properly when the value is a text that inclues a string-valued {context variable}',
        },
        {
          ...
          message:
            'should test if tap helper is working properly when it makes referece to string-valued context variable',
        },
        {
          ...
          message:
            'should test if tap helper is working properly when the value is a string literal that includes a string-valued {context function}',
        },
        {
          ...
          expected: 'beta. beta',
          message:
            'should test if tap helper is working properly when it makes reference to a a string-valued {context function}',
        },
        {
          ...
          message:
            'should test if tap helper is working properly when the value is a string literal that includes an object-valued {context variable}',
        },
        {
          ...
          expected: 'bar. bar',
          message:
            'should test if tap helper is working properly when it makes reference to an object-valued {context variable}',
        },
        {
          ...
          expected: 'a.foo is bar. a.foo is bar',
          message:
            'should test if tap helper is working properly when the value is string literal that calls a function within an object-valued {context variable}',
        },
        {
          ...
          expected: 'bar bar',
          message:
            'should test if tap helper is working properly when it makes reference to a function within an object-valued {context variable}',
        },
        {
    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          ...
          context: { n: ['Mick', 'Tom', 'Bob'] },
          expected:
            'Hello Mick! You have 30 new messages. Hello Tom! You have 30 new messages. Hello Bob! You have 30 new messages.',
